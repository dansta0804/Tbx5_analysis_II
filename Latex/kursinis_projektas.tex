...
Atliekant organizmų širdžių regeneracijos tyrimus įgijama vis daugiau žinių apie
ląstelių ir audinių atsinaujinimą, kurį lemia skirtingi faktoriai (pavyzdžiui,
kardiogeninis transkripcijos faktorius Tbx5, aktyvuojantis širdies
embriogenezės stadijos metu ekspresuojamus genus). Neretai esant patikimų
duomenų trūkumui šių faktorių veikimas skirtinguose organizmuose lyginamas,
taikant lyginamosios genomikos metodikas, todėl šiame darbe buvo siekiama
patikrinti, ar evoliucijos eigoje mažai pakitusių genomų homologiškų genų -
sintenijos blokų - analizė yra patikimas būdas tirti naminės pelės
(lot. \emph{Mus musculus}) ir zebražuvės (lot. \emph{Danio rerio}) genomus.

Šiame darbe, naudojantis R programavimo kalbos bibliotekomis, bioinformatiniais
įrankiais, analizuoti sintenijos blokams priklausantys naminės pelės ląstelių
pikai - ChIP sekoskaitos duomenys - ir su anotuotais pikais persidengiantys
zebražuvės genai, siekiant išsiaiškinti, ar sintenijos tyrimas yra tinkamas
būdas Tbx5 transkripcijos faktoriaus poveikio genams mechanizmams analizuoti.

Atliktos analizės rezultatai parodė, kad sintenijos blokų tyrimas, naudojant
ChIP sekoskaitos duomenis, nėra tinkamiausias būdas, siekiant įvertinti
\emph{Mus musculus} ir \emph{Danio rerio} organizmų homologiją, nes taikyti
sintenijos blokų paieškos metodai surado mažą dalį homologiškų naminės pelės ir
zebražuvės genomų fragmentų.
