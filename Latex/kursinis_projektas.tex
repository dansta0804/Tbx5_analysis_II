...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.7\linewidth]{../Tbx5_analysis_II/Figures/Synteny_blocks.png}
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{../Tbx5_analysis_II/Figures/Methods_tools.png}
        \vspace{-2\baselineskip}
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.5\linewidth]{../Tbx5_analysis_II/Figures/TTS_data_structure.png}
...
%\subsection{\textbf{Satsuma} įrankio veikimo principai}
%Tai yra populiariausias DNR sekų išlyginimu paremtą metodą taikantis įrankis.
%Šis įrankis realizuoja \textbf{kryžminės koreliacijos metodą}, paremtą sekų
%išlyginimais.


%\subsection{\textbf{Symap} įrankio veikimo principai}

%%%%%%%%%%%%%%%%%%%%%%%
% CINTENY REZULTATAS
%%%%%%%%%%%%%%%%%%%%%%%

%One problem of central importance is the identification of blocks of genes
%(or other markers) with evolutionary conserved order.
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.8\linewidth]{../Tbx5_analysis_II/Figures/SynCircos.png}
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.6\linewidth]{../Tbx5_analysis_II/Figures/Synteny_blocks_MM_chr.png}
        \vspace{-1\baselineskip}
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.6\linewidth]{../Tbx5_analysis_II/Figures/Synteny_blocks_DR_chr.png}
        \vspace{-1\baselineskip}
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{../Tbx5_analysis_II/Figures/Synteny_blocks_peaks.png}
        \vspace{-2\baselineskip}
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.7\linewidth]{../Tbx5_analysis_II/Figures/Unique_genes_MM.png}
        \vspace{-2\baselineskip}
        \caption*{\small\textbf{}}
        \label{fig:birds}
    \end{center}
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.7\linewidth]{../Tbx5_analysis_II/Figures/PWM_matches_all.png}
        \vspace{-2\baselineskip}
        \caption*{\small\textbf{}}
        \label{fig:birds}
    \end{center}
...
Čia pateikti lentelę, kurioje nurodyti, kiek atitikimų surasta.
T.y. kiek synteny blokų buvo nustatyta tarp pikų (kurie blokai
iš gautų su Cinteny įrankiu buvo tinkami ir priklausė pikams.)

\begin{table}[htb]
    \newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
    \small
    \caption*{\small\textbf{2 lentelė.}}
    \begin{tabular}{|c|c|c|}
        \hline
        \textbf{\thead{Mėginys}} & \textbf{\thead{Blokų\\skaičius}} &
            \textbf{\thead{Procentinė\\dalis}} \\
        \hline
        \emph{crdc\_mscl\_r1\_2} & \thead{39} & \thead{2.78\%}\\ 
        \hline
        \emph{emb\_fibr\_r1\_1} & \thead{41} & \thead{2.92\%}\\ 
        \hline
        \emph{emb\_fibr\_r2\_2} & \thead{40} & \thead{2.85\%}\\ 
        \hline
        \emph{emb\_fibr\_r3\_3} & \thead{40} & \thead{2.85\%}\\ 
        \hline
        \emph{heart\_r1\_1} & \thead{39} & \thead{2.78\%}\\ 
        \hline
        \emph{emb\_fibr\_r4\_4} & \thead{18} & \thead{1.28\%}\\ 
        \hline
        \emph{crdc\_fibr\_r1\_3} & \thead{25} & \thead{1.78\%}\\ 
        \hline
...
%\subsection*{\textbf{Satsuma} įrankis}
%Siekiant patikrinti metodų, leidžiančių identifikuoti \emph{synteny} blokus,
%tikslumą, buvo išbandytas \emph{Satsuma}\cite{SATSUMA} įrankis. Nustatytų
%\emph{synteny} blokų procentinė dalis pikų atžvilgiu pavaizduota 4 pav.
...
% \subsection{Pikų anotavimas}
% Atlikus pikų anotavimą kiekvieno mėginio anotuotų pikų skaičius ir su 
% \emph{Danio rerio} organizmo genais persidengiančių genų skaičius pateiktas
% stulpelinėse diagramose (4 pav.).
% \begin{figure}[htb]
%     \begin{center}
%         \includegraphics[width=0.8\linewidth]{../Tbx5_analysis_II/Figures/Annotated_genes.png}
%         \vspace{-2\baselineskip}
%         \caption*{\small\textbf{4 pav. Unikalių ir persidengiančių genų
%         skaičiaus stulpelinės diagramos}}
%         \label{fig:birds}
%     \end{center}
% \end{figure}

% Remiantis gautomis diagramomis galima pastebėti, kad didžiausias anotuotų pikų
% skaičius (unikalių genų skaičius) būdingas mėginiams \emph{emb\_fibr\_r1\_1},
% \emph{emb\_fibr\_r2\_2} ir \emph{emb\_fibr\_r3\_3}, kuriuose naminių pelių
% embrionų fibroblastai buvo veikti AGHMT, GHMT ir GMT kardiogeniniais
% transkripcijos faktoriais. Mažiausias genų skaičius nustatytas mėginyje, kuriame
% naminių pelių embrionų fibroblastų kamienas (\emph{emb\_fibr\_r4\_4}) veiktas
% tik Tbx5 transkripcijos faktoriumi.

% Dešinėje pateiktoje stulpelinėje diagramoje galima pastebėti, kad tuose pačiuose
% mėginiuose, kuriuose buvo tirtas vienodas embrionų fibroblastų kamienas, tačiau
% taikytos skirtingos sąlygos, su zebražuvės genais persidengiančių genų skaičius
% nebuvo vienodas. Nepaisant to, kad persidengiančių genų skaičius šiuose
% mėginiuose nebuvo itin didelis (didžiausias skirtumas nustatytas tarp
% \emph{emb\_fibr\_r1\_1} ir \emph{emb\_fibr\_r3\_3} mėginių, kur persidengiančių
% genų skaičiaus skirtumas buvo lygus 127 genams), galima daryti išvadą, kad
% taikant skirtingas sąlygas (veikiant skirtingu kardiogeninių faktorių komplektu)
% dalyje genų pikai nebuvo nustatyti.
...
\bibitem{ENSEMBL} Magali Ruffier, Andreas Kähäri, Monika Komorowska, Stephen
