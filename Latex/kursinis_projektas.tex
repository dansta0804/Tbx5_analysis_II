...
nustatyta, kokiems genominiams elementams priklauso kiekvienas pikas. Gauti
rezultatai pateikti antroje lentelėje (lentelė 2).
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{../Figures/PWM_matches_all.png}
        \vspace{-2\baselineskip}
        \caption*{\small\textbf{}}
        \label{fig:birds}
    \end{center}
