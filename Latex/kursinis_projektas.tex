...
\begin{table}[htb]
    ...
    \hline
        \emph{crdc\_mscl\_r1\_2} & \thead{HL - 1\\ (širdies raumens)} &
        C57BL/6J & \thead{TRE\\ promotorius\\ (2 d.)} & - & \thead{EXP030898}\\ 
    \hline
        \emph{heart\_r1\_1} & Širdies prieširdžių & C57BL/6 & - & \thead{Tbx5\\
        (sc-17866)} & \thead{EXP058852}\\
    \hline
        \emph{emb\_fibr\_r1\_1} & \thead{MEF\\ (embrionų fibroblastai)} &
        C57BL/6 & \thead{AGHMT\\ (2 d.)} & \thead{anti-Tbx5\\ (sc-17866)} &
        \thead{EXP058843}\\
    \hline
        \emph{emb\_fibr\_r2\_2} & \thead{MEF\\ (embrionų fibroblastai)} &
        C57BL/6 & \thead{GHMT\\ (2 d.)} & \thead{Tbx5\\ (sc-17866)} &
        \thead{EXP058847}\\
    \hline
        \emph{emb\_fibr\_r3\_3} & \thead{MEF\\ (embrionų fibroblastai)} &
        C57BL/6 & \thead{GMT\\ (2 d.)} & \thead{Tbx5\\ (sc-17866)} &
        \thead{EXP058850}\\
    \hline
        \emph{emb\_fibr\_r4\_4} & \thead{MEF\\ (embrionų fibroblastai)} &
        C57BL/6 & \thead{Tbx5\\(2 d.)} & \thead{Tbx5\\ (sc-17866)} &
        \thead{EXP058856}\\
    \hline
        \emph{crdc\_fibr\_r1\_3} & \thead{Pelių naujagimių širdies\\
        fibroblastų, ekspresuojančių\\ didelį kiekį T antigeno, linija} & CD1 &
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        \hline
            ...
            26.7\% & 21.97\% \\
        \hline
            \textbf{\thead{\emph{emb\_fibr\_r4\_4}}} & 6.49\% &
            \textbf{16.34\%} & \textbf{36.73\%} & \textbf{28.37\%} \\
        \hline
            \textbf{\thead{\emph{crdc\_fibr\_r1\_3}}} & \textbf{30.83\%} &
            12.06\% & 24.88\% & 20.12\% \\
        \hline
    \end{tabular}
\end{table}
...
\bibitem{ARTICLE1} Institute of Medicine (US) Committee on Technological
...
\bibitem{ARTICLE2} Dzobo K, Thomford NE, Senthebane DA, Shipanga H, Rowe A,
...
\bibitem{ARTICLE3} Liu, D., Hunt, M. \& Tsai, I.J. Inferring synteny between
...
\bibitem{ARTICLE4} Lallemand, T.; Leduc, M.; Landès, C.; Rizzon, C.; Lerat, E.
...
\bibitem{ENS_SYN} Xosé M. Fernández-Suárez and Michael K. Schuster
...
\bibitem{NCBI_MAP} Rangwala SH, Kuznetsov A, Ananiev V, Asztalos A, Borodin E,
...
\bibitem{SYNCHRO} Drillon G, Carbone A, Fischer G. SynChro: a fast and easy
tool to reconstruct and visualize synteny blocks along eukaryotic chromosomes.
PLoS One. 2014;9:1–8.

\bibitem{BLASTP} Camacho, C.; Coulouris, G.; Avagyan, V.; Ma, N.;
Papadopoulos, J.; Bealer, K.; Madden, T.L. BLAST+: Architecture and
applications. BMC Bioinform. 2009, 10, 421.

\bibitem{DEBRUIJN} Lin, Y., Nurk, S. \& Pevzner, P.A. What is the difference
...
\bibitem{TST} Bentley JL, Sedgewick R. Fast algorithms for sorting and searching
...
\bibitem{DAGCHAINER} Haas, B.J.; Delcher, A.L.; Wortman, J.R.; Salzberg, S.L.
...
\bibitem{CHIP} Wang Q, Li M, Wu T, Zhan L, Li L, Chen M, Xie W, Xie Z, Hu E,
...
\bibitem{HOCOMOCO} Kulakovskiy IV, Vorontsov IE, Yevshin IS, Sharipov RN,
