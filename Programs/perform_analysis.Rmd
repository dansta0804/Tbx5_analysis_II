...
```{r Paths}
# Declaring paths:
TBX5_FOLDER <- "/home/daniele/Desktop/Darbas/Tbx5_analysis_cont"
...
for (motif in 1:length(MOTIF_LIST)) {
    ...
    seq_object <- readDNAStringSet(paste0(CONTROL_SEQ, fasta_file))
    PWM_match <- 0
    ...
    pwm_results[motif, 3] <- PWM_match
    write.table(pwm_results, paste0(INTERMEDIATE_FILES, "con_motifs_modified"))
}
