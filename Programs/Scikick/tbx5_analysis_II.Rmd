...
This part of the work describes the analysis that was performed to
determine whether the search of synteny blocks is a suitable method that is
used to evaluate homology between *Mus musculus* and *Danio rerio* genomes.
...
plot4 <- ggplot(genes_synteny, aes(x = Sample, y = as.numeric(Percentage))) +
    ...
    coord_cartesian(ylim = c(0,
                             as.numeric(max(genes_synteny$Percentage)) + 3)) +
    theme(axis.text = element_text(size = 10, colour = "black"),
          axis.text.x = element_text(angle = 45, hjust = 1, size = 12,
                                     vjust = 1, face = "bold"),
          axis.text.y = element_text(size = 12, face = "bold"),
