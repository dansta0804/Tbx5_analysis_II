...
library(TxDb.Drerio.UCSC.danRer11.refGene, org.Dr.eg.db)
library(BSgenome.Drerio.UCSC.danRer11)

gene_ranges <- genes(TxDb.Drerio.UCSC.danRer11.refGene)

gene_ranges$gene_symbol <- mapIds(org.Dr.eg.db, keys = gene_ranges$gene_id, column = "SYMBOL", keytype = "ENTREZID", multiVals = "first")
selectGenes <- toupper(gene_ranges$gene_symbol) %in% gene_list
gene_ranges <- gene_ranges[selectGenes]
geneSequences <- getSeq(BSgenome.Drerio.UCSC.danRer11, gene_ranges)
names(geneSequences) <- gene_ranges$gene_symbol
...
drosophila.genome <- BSgenome.Drerio.UCSC.danRer11
get_sequence(gene_ranges, drosophila.genome)
